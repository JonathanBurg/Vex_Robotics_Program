...
//motor_group LeftSide = motor_group(LeftSideMotorA, LeftSideMotorB, LeftSideMotorC);
...
//motor_group RightSide = motor_group(RightSideMotorA, RightSideMotorB, RightSideMotorC);
